		...
		for player, data in pairs(ESPPlayerCache) do
			...
			if _G.Config.skeleton and data.Skeleton then
				...
				if char then
					...
					local upperLeg = char:FindFirstChild("UpperTorso")
					...
					drawLine(skeleton.HeadToNeck, head, neck)
					drawLine(skeleton.NeckToTorso, neck, torso)
					...
					drawLine(skeleton.TorsoToUpperLeg, torso, upperLeg)
					...
					drawLine(skeleton.NeckToHead, neck, head)
				end
