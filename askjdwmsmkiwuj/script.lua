...
local raw1 = "https://raw.githubusercontent.com/sanyogsakenkok/lmfaodawg/refs/heads/main/askjdwmsmkiwuj/a.lua?v=" .. tostring(tick())
local raw2 = "https://raw.githubusercontent.com/sanyogsakenkok/lmfaodawg/refs/heads/main/askjdwmsmkiwuj/b.lua?v=" .. tostring(tick())
loadstring(HttpGet(raw1, true))()
...
--// Misc \\--
local misc = _G.CustomGUI.CreateTab("Misc")



loadstring(HttpGet(raw2, true))()
