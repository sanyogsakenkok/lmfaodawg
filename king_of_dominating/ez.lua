...
local raw1 = "https://raw.githubusercontent.com/sanyogsakenkok/lmfaodawg/refs/heads/main/king_of_dominating/a.lua?v=" .. tostring(tick())
local raw2 = "https://raw.githubusercontent.com/sanyogsakenkok/lmfaodawg/refs/heads/main/king_of_dominating/b.lua?v=" .. tostring(tick())
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    ...
    elseif input.KeyCode == Enum.KeyCode.C and circle.Visible then
...
local flashlightSection = SurvExploitsTab:CreateSection({
    Name = "Flashlight"
})
...
CheatSection:AddToggle({
    ...
    Value = Underline.Visible,
    Callback = function (state)
        ScreenGui.Visible = state
    end
})
CheatSection:AddToggle({
    Name = "Toggle Circle",
