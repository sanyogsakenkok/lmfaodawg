...
local function UpdatePlayerHighlight(player, highlight)
...
local function enableObjectESP(objectName, labelText, color)
...
local function disableObjectESP(objectName)
