...
local func_link = "https://raw.githubusercontent.com/sanyogsakenkok/lmfaodawg/refs/heads/main/04082025/func.lua?v=" .. tostring(tick())
...
-- Заголовок
local Title = Instance.new("TextLabel")
Title.Text = "Anal Destroyer v3.1.7"
Title.Font = Enum.Font.SourceSansBold
Title.TextSize = 24
...
for _, func in ipairs(ToggleSelectFunctions) do
    if func.Name == "Unblock Window" or func.Name == "Block All Windows" or func.Name == "Pallet Exploit" then
        CreateToggleSelect(func)
    end
end
