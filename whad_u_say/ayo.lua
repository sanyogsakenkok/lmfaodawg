    ...
    while true do
        if loaded then
            ...
            if not allright then
                ...
                game.StarterGui:SetCore("SendNotification", { 
                    Title = "Anal Destroyer [Error Debug]",
...
local raw1 = "https://raw.githubusercontent.com/sanyogsakenkok/lmfaodawg/refs/heads/main/whad_u_say/a.lua?v=" .. tostring(tick())
local raw2 = "https://raw.githubusercontent.com/sanyogsakenkok/lmfaodawg/refs/heads/main/whad_u_say/b.lua?v=" .. tostring(tick())
...
KeybindsSection:AddKeybind({
    Name = "Magic Hit",
    Value = _G.Keybind.magic_hit or nil,
    Callback = function(v) _G.Keybind.magic_hit = typeof(v) == "EnumItem" and v or nil end
})
