...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.magic_hatchet and not gameProcessed then
        MagicHatchet()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.break_all_pallets and not gameProcessed then
        BreakAllPallets()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.hook_target and not gameProcessed then
        HookSurvivor()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.grab_target and not gameProcessed then
        GrabSurvivor()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.break_all_generators and not gameProcessed then
        KickAllGenerators()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.make_sound and not gameProcessed then
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.pallet_exploit and _G.Config.enabled_PalletExploit then
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.bless_all_totems and not gameProcessed then
        BlessAllTotems()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.open_all_lockers and not gameProcessed then
        OpenAllLockers()
    end
end)
-- [FUNCTION] Self Heal
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.heal_yourself then
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.heal_other then
...
game:GetService("UserInputService").InputBegan:Connect(function (input, gameProcessed)
    if input.KeyCode == _G.Keybind.stun_yourself and not gameProcessed then
        stun()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if input.KeyCode == _G.Keybind.blind_killer and not gameProcessed then
        blindklr("start")
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.tp_to_killer then
        teleportToKiller()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.tp_to_hatch then
        ToggleFly()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    ...
    local jumpCD = 0.5
    if input.KeyCode == _G.Keybind.jump then
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if input.KeyCode == _G.Keybind.dash and not gameProcessed then
        ragedash()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if input.KeyCode == _G.Keybind.legitdash and not gameProcessed then
...
game:GetService("UserInputService").InputEnded:Connect(function(input)
    if input.KeyCode == _G.Keybind.legitdash then
...
game:GetService("UserInputService").InputBegan:Connect(function(input)
    if input.KeyCode == _G.Keybind.moonwalk then
        ToggleMoonwalk()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed then return end
    if input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == _G.Keybind.speedhack then
        local player = game:GetService("Players").LocalPlayer
...
UIS.InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.tp_to_survivor then
        teleportToSurv()
    end
end)
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.remote_interaction_1 then
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == _G.Keybind.remote_interaction_2 then
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if input.KeyCode == _G.Keybind.animation and not gameProcessed then
        played = not played
